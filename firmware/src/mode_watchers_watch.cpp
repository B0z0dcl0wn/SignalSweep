...
String getWatchersTargetsJson() {
    ...
    // joined for the same reason as the other two, ~8 B. The alert count joined
    // so the header's "alerts since power-on" ticks live, ~12 B. The theme
    // joined like the LED mode, ~10 B.)
    //
